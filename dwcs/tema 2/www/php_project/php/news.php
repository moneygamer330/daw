...
<head>
    ...
    <link rel="stylesheet" href="/php_project/css/news.css">
    <link rel="shortcut icon" href="/php_project/img/icon.ico" type="image/x-icon"/>
    <title>News - Cloud Motorsports</title>
</head>
<body>
        ...
        <nav>
            ...
            <?php 
                if ($loggedIn): ?>
                    ...
                    <?php endif; ?>
                <li><a href=""></a><img src="/php_project/img/carro-de-la-compra.png" alt="cart"></li>
            </ul>
        </nav>
    </div>
</div>      
...
<div class="news-section">
    <div class="news-item">
        <img src="/php_project/img/us-grand-prix.jpg" alt="US Grand Prix 2024">
    ...
    <div class="news-item">
        <img src="/php_project/img/bmw-motorsport.jpg" alt="BMW M Motorsport Indianapolis">
        <div class="news-details">
